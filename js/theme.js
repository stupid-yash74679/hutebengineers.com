...
(function ($) {
    ...
    var $noticeTopBar = {
        ...
        init: function () {
            var self = this;
            if (!$.cookie('StupidPixelNoticeTopBarClose')) {
                self.build().events();
            } else {
        ...
        saveCookie: function () {
            var self = this;
            $.cookie('StupidPixelNoticeTopBarClose', true);
            return this;
        }
    }
    ...
    $('[data-toggle-class]').on('click', function (e) {
        e.preventDefault();
        $(this).toggleClass($(this).data('StupidPixel-toggle-class'));
    });
...
(function (theme, $) {
    ...
    PluginGDPR.prototype = {
        initialize: function ($el, opts) {
            ...
            var self = this;
            if (!$.cookie('StupidPixel-privacy-bar')) {
                setTimeout(function () {
                    self.options.wrapper.addClass('show');
                }, self.options.cookieBarShowDelay);
            }
            if ($.cookie('StupidPixel-gdpr-preferences')) {
                var preferencesArr = $.cookie('StupidPixel-gdpr-preferences').split(',');
            ...
            $('.gdpr-preferences-form').on('submit', function (e) {
                ...
                $.cookie('StupidPixel-privacy-bar', true);
                setTimeout(function () {
                    ...
                    setTimeout(function () {
                        ...
                        if ($.cookie('StupidPixel-gdpr-preferences')) {
                            $.cookie('StupidPixel-gdpr-preferences', formData);
                            location.reload();
                        } else {
                            $.cookie('StupidPixel-gdpr-preferences', formData);
            ...
            var self = this;
            $.removeCookie('StupidPixel-privacy-bar');
            $.removeCookie('StupidPixel-gdpr-preferences');
            return this;
        }
    };
...
(function (theme, $) {
    ...
    PluginGDPRWrapper.prototype = {
        initialize: function ($el, opts) {
            ...
            var self = this;
            if ($.cookie('StupidPixel-gdpr-preferences') && $.cookie('StupidPixel-gdpr-preferences').indexOf(self.options.checkCookie) != -1) {
                $.ajax({
